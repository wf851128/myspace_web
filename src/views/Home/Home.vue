<template>
  <div class="content">
    <div class="content__left">
      <h4 class="content__left__title">热门帖子</h4>
      <div class="content__left__header">
        ...
        <button class="btn-publish"
                @click="goPublish">发表</button>
      </div>
      <ul class="content__left__list">
        <li class="content__left__item"
            v-for="post in postList"
            :key="post.id">
          <div class="post">
            <a class="vote">
              <span class="iconfont icon-up"
                    @click="vote(post.id, '1')"></span>
            </a>
    ...
    <div class="content__right">
      <div class="content__right__communities">
        <h2 class="content__right__communities-title">今日火热频道排行榜</h2>
        <ul class="content__right__communities-content">
        ...
        <button class="content__right__view-all">查看所有</button>
      </div>
      <div class="content__right__trending">
        <h2 class="content__right__trending-title">持续热门频道</h2>
        <ul class="content__right__rank">
          <li class="content__right__rank-cell">
            <div class="content__right__rank-cell-info">
