  ...
  <div class="content">
    <div class="content__left">
      <div class="content__left__container">
        ...
        <div class="content__left__container-frame">
          <h4 class="content__left__container-title">{{post.title}}</h4>
          <div class="content__left__container-info">{{post.content}}</div>
          <div class="content__left__user-btn">
            <span class="btn-item">
    ...
    <div class="content__right">
      <div class="content__right__topic-info">
        <h5 class="content__right__topic-header"></h5>
        <div class="content__right__topic-info">
          <a class="avatar"></a>
          <span class="content__right__topic-name">b/{{post.community_name}}</span>
        </div>
        <p class="content__right__topic-desc">树洞 树洞 无限树洞的树洞</p>
        <ul class="content__right__topic-num">
          <li class="content__right__topic-num-item">
        ...
        <div class="content__right__date">Created Apr 10, 2008</div>
        <button class="content__right__topic-btn">JOIN</button>
      </div>
    </div>
  </div>
</template>
